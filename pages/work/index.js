      ...
      <div className='flex xl:flex-row gap-x-8 mb-[200px] xl:mb-0'>
        <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0 '>
          <motion.h2 variants={fadeIn('up', 0.3)} initial="hidden" animate="show" exit="hidden" className='h2 xl:mt-20 text-lg
           mt-60 xl:text-[3rem]'>Meus Projetos <span className='text-accent '>.</span></motion.h2>
          <motion.p variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit="hidden"
           className='mb-4 max-w-[400px] mx-auto lg:mx-0 text-xs xl:text-lg'>"Desenvolvi diversos projetos utilizando
           ...
           Esse resumo destaca as principais tecnologias e as habilidades que você aplicou nos projetos. </motion.p>
        </div>
